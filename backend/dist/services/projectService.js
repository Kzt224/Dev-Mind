...
export class ProjectService {
    ...
    async fetchProjectById(id, userId) {
        try {
    ...
    async update(id, data, authorId) {
        ...
        try {
            ...
            const isSame = name === existing.name &&
    ...
    async updateProjectProgress(projectId, authorId, tx) {
    ...
    async searchProject(userId, query) {
        try {
