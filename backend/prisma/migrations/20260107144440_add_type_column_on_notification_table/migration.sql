...
INSERT INTO "new_Notification" ("authorId", "body", "createdAt", "header", "id", "projectId", "read", "taskId") SELECT "authorId", "body", "createdAt", "header", "id", "projectId", "read", "taskId" FROM "Notification";
