...
class SendNotification {
    ...
    //sent notification for delay task
    async sendDelayNoti() {
        try {
    ...
    //sent notification for finished task
    ...
    async sendAssignNoti({ memberId, authorId, taskId, projectId, taskName } = {}) {
        try {
    ...
    // send notification when a task is modified
    async sendModifyNoti({ recipientId, modifierId, taskId, projectId, taskName } = {}) {
        try {
